...
from ...constants import KEEP, LEFTDOCK, SELECTIONCHANGED
from ...helperwin import BOLD, UNCHANGED, EditField, ExTags
...
class ExTagsPlugin(ExTags):
    ...
    def __init__(self, parent=None, row=None, files=None, status=False):
        ...
        super().__init__(parent, row, files, status, False)
...
dialogs = [
    ("Extended Tags", ExTagsPlugin, LEFTDOCK, False),
]
