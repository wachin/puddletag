...
from ...puddleobjects import ListBox, ListButtons, PuddleConfig, natural_sort_key
...
def load_fields():
    ...
    return cparser.get("view_all_fields", "fields", ["__filename", "__dirpath"])
...
class ButtonsAndList(QFrame):
    def __init__(self, parent=None, title="", add_text=ADD_TEXT, help_text=""):
    ...
    def addItem(self):
        ...
        (text, ok) = QInputDialog().getItem(
            self, "puddletag", self.addText, patterns, row
        )
        if ok:
