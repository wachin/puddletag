...
# Below here is generated by `update_translation.py`
    translate("Menus", "Find Duplicates")
    translate("Menus", "Find and manage duplicate tracks")
    translate("Menus", "View Logs")
    translate("Menus", "View application logs")
    translate("Menus", "Library Statistics")
    translate("Menus", "Show statistics about the current library")
    translate("Menus", "&Export...")
    translate("Menus", "Export tag information to a file (CSV, HTML, etc.)")
    ...
    translate("Menus", "Update the selected files from their filename using the pattern.")
    ...
    translate("Functions", "Restart for dir")
    translate("Functions", "False")
    translate("Functions", "Padding")
    translate("Functions", "1")
