...
def dont_execute():
    ...
    translate("Menus", "Format the selected field(s) using the pattern.")
    ...
    translate(
        "Menus", "Update the selected files from their filename using the pattern."
    )
    ...
    translate(
        "Menus",
        "Select all files belonging to the directories of those selected. Otherwise (if only a single directory is selected) selects all the files in the previous directory.",
    )
    ...
    translate("Menus", "Rename the selected files using the pattern.")
    ...
    translate(
        "Menus", "Focuses the current file's parent folder in the Filesystem view"
    )
    ...
    # Functions
    translate(
        "Functions", "Artwork: Filenames='$1', Description='$2', Case Sensitive=$3"
    )
    translate("Functions", "Load Artwork")
    translate(
        "Functions",
        "&Filenames to check (;-separated, shell wildcards [eg. *] allowed)",
    )
    translate("Functions", "&Default description (can be pattern):")
    translate("Functions", "Match filename's &case:")
    translate(
        "Functions", "Autonumbering: $0, Start: $1, Restart for dir: $2, Padding: $3"
    )
    ...
    translate("Functions", "Converts all unicode chars to ASCII.")
